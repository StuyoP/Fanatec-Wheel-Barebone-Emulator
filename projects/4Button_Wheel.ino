...
#ifdef HASBUTTONS
#define buttonsnum 4                  // how many buttons are you using?
uint8_t buttonsPins[] = { 5, 6,  7,  8};    // what arduino pins are you using? 
uint8_t buttonsBits[] = { 13, 10, 6, 8};    // what bits do you want each button to affect? use the last comment in this file as reference.
#endif
